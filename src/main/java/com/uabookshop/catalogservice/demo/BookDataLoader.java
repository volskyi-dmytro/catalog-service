...
public class BookDataLoader {
    ...
    public void loadBookTestData() {
        ...
        var book3 = Book.of("1234567803", "The Museum of Abandoned Secrets", "Oksana Zabuzhko", 17.90);
        var book4 = Book.of("1234567804", "Sweet Darusya: A Tale of Two Villages", "Maria Matios", 12.90);
        var book5 = Book.of("1234567805", "Zhadan Diaries: The Ukrainian Night", "Serhiy Zhadan", 14.90);
        var book6 = Book.of("1234567806", "The Lost Button", "Irene Rozdobudko", 10.90);
        var book7 = Book.of("1234567807", "Mesopotamia", "Serhiy Zhadan", 16.90);
        var book8 = Book.of("1234567808", "The Orphanage", "Serhiy Zhadan", 15.90);
